"""
Django settings for homeharmony project.
...
SECRET_KEY = 'django-insecure-c!wqv+n@i50ryz#-wbzv=9$n%&h&p%s(#75iirl9oqyqv%@m_8'
...
ROOT_URLCONF = 'homeharmony.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'homeharmony' / 'templates',  # ← общие шаблоны проекта
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
